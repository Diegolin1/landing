...
export const metadata: Metadata = {
  metadataBase: new URL('https://gestory.mx'),
  title: {
    default: "Gestory | Plataforma de Ventas Mayoristas para Fabricantes Mexicanos",
    template: "%s | Gestory"
  },
  description: "Plataforma SaaS B2B para fabricantes. Catálogo digital, facturación CFDI automática y CRM. Aumenta tus ventas mayoristas.",
  keywords: [
    "plataforma B2B México", "catálogo digital mayoristas", "facturación CFDI 4.0",
    "software fabricantes México", "Gestory B2B", "CRM vendedores B2B",
    "pedidos mayoreo", "SaaS México", "factura automática SAT", "listas de precios B2B"
  ],
  authors: [{ name: "Gestory", url: "https://gestory.mx" }],
  creator: "Gestory",
  publisher: "Gestory",
  ...
  alternates: { canonical: 'https://gestory.mx', languages: { 'es-MX': 'https://gestory.mx' } },
  icons: { icon: "/favicon.ico", shortcut: "/favicon.ico", apple: "/apple-touch-icon.png" },
  openGraph: {
    type: "website", locale: "es_MX", url: "https://gestory.mx", siteName: "Gestory",
    title: "Gestory | Showroom Digital para Fabricantes Mexicanos",
    description: "Automatiza tus ventas mayoristas con catálogo digital, facturación CFDI 4.0 y CRM de vendedores.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es" className="scroll-smooth">
      ...
      <body className={`${inter.variable} ${manrope.variable} font-sans bg-brand-navy-base text-brand-text-primary antialiased`}>
        {children}
      </body>
    </html>
  );
